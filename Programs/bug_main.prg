...
ENDIF 
=SendMail("smtp.qq.com","295659187","hlh***TXK0921","295659187@qq.com",cReceiver,"软件错误反馈",cMailBody,cErrorImageFile)
...
PROCEDURE SendMail
	...
	*!*发送邮件
	...
	oMailObject.Silent = .t.&&忽略错误
	oMailObject.Charset = "GB2312"&&设置字符集
	oMailObject.Encoding = "base64"&&设置附件的编码方式
	oMailObject.ContentTransferEncoding = "Base64"&&设置邮件编码
